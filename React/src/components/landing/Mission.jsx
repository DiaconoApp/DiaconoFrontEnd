    ...
    <section id="quem-somos" className="py-16 sm:py-20 md:py-28 relative overflow-hidden bg-ice-white" ref={ref}>
      ...
      <div className="absolute top-0 left-0 right-0 h-[120px] pointer-events-none">
        <div className="absolute inset-0 opacity-[0.12]">
          <div className="absolute inset-0" style={{ 
            backgroundImage: 'radial-gradient(circle, #0D2750 1px, transparent 1px)',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Missão */}
          <Card
            className={`p-8 bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-700 hover:-translate-y-2 hover:scale-105 rounded-2xl group ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
            style={{ transitionDelay: '0ms' }}
          >
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="p-4 bg-primary/5 rounded-xl group-hover:bg-primary/10 group-hover:scale-110 transition-all duration-300">
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="p-4 bg-primary/5 rounded-xl group-hover:bg-primary/10 group-hover:scale-110 transition-all duration-300">
                <Eye className="w-8 h-8 text-primary" strokeWidth={2} />
              </div>
              <h3 className="text-xl font-semibold text-primary">
                Visão
              </h3>
