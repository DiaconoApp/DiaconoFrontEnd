...
export function ModalExclusaoRecorrencia(props) {
    return (
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col items-start gap-2">
                        <label className="flex items-center border rounded p-3 gap-3 w-full cursor-pointer border-icf-primary-200 bg-surface-50 hover:bg-icf-primary-50">
                            <input type="radio" name="excluirRecorrencia" className="appearance-none w-3 h-3 rounded-full border-2 border-icf-primary-300 checked:bg-icf-primary-400 transition-colors" />
                            <div className="flex flex-col">
