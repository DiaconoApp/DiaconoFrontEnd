        ...
        <div className="flex min-h-screen">
            ...
            <div className="w-1/2 flex items-center justify-center">
                <div className="w-[55%] flex flex-col gap-5">
                    ...
                    <select className="text-diacono-blue-400 border border-diacono-blue-100 rounded-lg h-10 p-2 focus:outline-none focus:border-diacono-blue-200 focus:border-3 text-[14px]">
